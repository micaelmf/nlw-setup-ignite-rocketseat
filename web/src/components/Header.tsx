  ...
  return (
    <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
      ...
      <Dialog.Root>
        ...
        {/** 
         * O Portal vai jogar o modal para fora do componente Header,
         * fazer com que ocupe o espaço da tela toda 
         */}
        <Dialog.Portal>
          <Dialog.Overlay className="w-scree h-screen bg-black/80 fixed inset-0" />
          <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <Dialog.Close className="absolute right-6 top-6 text-zinc-400 rounded-lg hover:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-zinc-800">
